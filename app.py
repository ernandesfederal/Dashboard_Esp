...
def load_data():
    try:
        data = pd.read_csv("C:/Users/Acer/OneDrive - ifpi.edu.br/Documentos/Ciência de Dados/Espec_Ciecia_Dados_UFMA/Visualização de dados/Dashboard_UFMA/houses_to_rent_limp.csv", sep=",")
        return data
...
# Carregar a imagem
def load_image():
    return "C:/Users/Acer/OneDrive - ifpi.edu.br/Documentos/Ciência de Dados/Espec_Ciecia_Dados_UFMA/Visualização de dados/Dashboard_UFMA/fig.png"
